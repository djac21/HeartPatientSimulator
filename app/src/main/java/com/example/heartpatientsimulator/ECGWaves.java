...
public class ECGWaves extends ListFragment {
	...
	String[] waves = {"Healthy", "Bundle Branch Block", "Cardiomyopathy", "Ventricular Fibrillation", "Atrial Fibrillation", "Hypertrophy", "Myocardial Infarction", "Myocarditis", "Unstable Angina", "Valvular Heart Disease", "Ventricular Tachycardia", "Sample 1", "Sample 2", "Sample 3", "Sample 4", "Sample 5"};
		...
		list.setOnItemClickListener(new OnItemClickListener() {
		        ...
		        public void onItemClick(AdapterView<?> arg0, View view, int arg1, long arg2) {
		            ...
		            case 10:
		                ...
		                break;
                    case 11:
                        Intent myIntent11 = new Intent(view.getContext(), Sample1.class);
                        startActivityForResult(myIntent11, 0);
                        break;
                    case 12:
                        Intent myIntent12 = new Intent(view.getContext(), Sample2.class);
                        startActivityForResult(myIntent12, 0);
                        break;
                    case 13:
                        Intent myIntent13 = new Intent(view.getContext(), Sample3.class);
                        startActivityForResult(myIntent13, 0);
                        break;
                    case 14:
                        Intent myIntent14 = new Intent(view.getContext(), Sample4.class);
                        startActivityForResult(myIntent14, 0);
                        break;
                    case 15:
                        Intent myIntent15 = new Intent(view.getContext(), Sample5.class);
